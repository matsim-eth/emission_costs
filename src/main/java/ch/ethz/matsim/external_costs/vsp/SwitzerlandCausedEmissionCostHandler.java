...
public class SwitzerlandCausedEmissionCostHandler implements VehicleEntersTrafficEventHandler, VehicleLeavesTrafficEventHandler, WarmEmissionEventHandler, ColdEmissionEventHandler, EmissionCostHandler{

	private static final Logger LOG = Logger.getLogger(SwitzerlandCausedEmissionCostHandler.class);
	...
	public SwitzerlandCausedEmissionCostHandler(final EmissionCostModule emissionCostModule) {
		this(emissionCostModule, null);
	}

	public SwitzerlandCausedEmissionCostHandler(final EmissionCostModule emissionCostModule, final PersonFilter pf) {
		this.emissionCostModule = emissionCostModule;
		this.pf = pf;
	}

	public static void main(String[] args) {
		String emissionEventsFile = args[0];
		String emissionFilesPath = args[1];

		EventsManager eventsManager = EventsUtils.createEventsManager();

		EmissionsConfigGroup emissionsConfigGroup = new EmissionsConfigGroup();
		emissionsConfigGroup.setAverageColdEmissionFactorsFile(emissionEventsFile + "/hbefaFiles/v3.2/EFA_ColdStart_vehcat_2005average.txt");
		emissionsConfigGroup.setAverageWarmEmissionFactorsFile(emissionEventsFile + "/hbefaFiles/v3.2/EFA_HOT_vehcat_2005average.txt");
		emissionsConfigGroup.setDetailedColdEmissionFactorsFile(emissionFilesPath + "/hbefaFiles/v3.2/EFA_ColdStart_SubSegm_2005detailed.txt");
		emissionsConfigGroup.setDetailedWarmEmissionFactorsFile(emissionFilesPath + "/hbefaFiles/v3.2/EFA_HOT_SubSegm_2005detailed.txt");
		emissionsConfigGroup.setEmissionEfficiencyFactor(1.0);

		EmissionCostModule ecm = new EmissionCostModule(emissionsConfigGroup);
		SwitzerlandCausedEmissionCostHandler ech = new SwitzerlandCausedEmissionCostHandler(ecm);
